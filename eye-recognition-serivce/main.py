...
from controller.EyeRecognitionModelController import router as eye_model_router
...
app.include_router(eye_model_router)
...
async def root():
    ...
    """
    return {"message": "Chào mừng đến với API Hệ thống Kiểm tra An ninh bằng Đồng tử Mắt"}
